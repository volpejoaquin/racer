...
export const QUALY_A_SAMPLE: RaceParticipantTrackActivity[] = [
  {
...
export const QUALY_B_SAMPLE: RaceParticipantTrackActivity[] = [
  {
     "state": RaceParticipantTrackActivityState.on_pit,
     "race_participant":{
        "team":{
...
export const QUALY_SAMPLE = QUALY_A_SAMPLE.concat(QUALY_B_SAMPLE);
